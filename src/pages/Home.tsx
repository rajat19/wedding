    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[80vh] flex items-center justify-center bg-gradient-hero">
        ...
        <div className="relative z-10 text-center px-4 space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-gradient-primary">
            Sarah & Michael
          </h1>
            ...
            <div className="flex flex-col items-center gap-2 pt-4">
              <div className="flex items-center gap-2 text-lg">
                ...
                <span className="font-medium">
                  {format(new Date(nextEvent.event_date), 'MMMM dd, yyyy')}
                </span>
              </div>
              <div className="flex items-center gap-2 text-lg">
          ...
          <Card className="hover:shadow-lg transition-smooth">
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Find accommodation and travel information
                </p>
                <Link to="/travel">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              We met on a sunny afternoon in a small coffee shop downtown. What started as a 
              chance encounter turned into countless conversations, adventures, and memories 
              that we'll cherish forever. Now, we're excited to begin this new chapter together 
